...
**All 171 dirs under `engine/features/` accounted for.** 85 feature &middot; 47 blob &middot; 3 companion &middot; 26 consumer &middot; 10 game_logic.
...
| `smt_rom` | **blob** | unused | `rom`&times;10 | &mdash; |
