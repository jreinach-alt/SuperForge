...
**All 157 dirs under `engine/features/` accounted for.** 75 feature &middot; 44 blob &middot; 3 companion &middot; 25 consumer &middot; 10 game_logic.
...
| `region` | **feature** | unused | `dp` | &mdash; |
...
| `tick_scale` | **feature** | unused | &mdash; | `region` |
