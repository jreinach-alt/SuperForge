...
| Spaceship Pack | **permissive commercial grant; CC0 deed NOT confirmed** — the page grants "Free for commercial use" with no CC0 deed label (F5, and §7 leaves it open) |

The Four Seasons grant covers everything this repo does with the art but is
not a dedication, and the Spaceship Pack's CC0 status is an **open question**,
not a settled one.
...
| **F5** | The Spaceship Pack's CC0 status remains **unconfirmed**: the reachable page grants "Free for commercial use" with no CC0 deed label. Open since 2026-07-19 | **LOW** (the live grant covers the use) | recorded honestly in `NOTICE`; carried as a standing limitation in §7 |
