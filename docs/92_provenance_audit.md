...
Six asset sheets for an unbuilt `tiles16` platformer concept, **generated by
the project owner with ChatGPT and supplied on 2026-09-08**. Same situation as
...
six files as supplied, and the pack README carries the same origin caveat at
the top of the file.

What IS established is what the sheets ARE, measured rather than assumed and
reproducible from the bytes: 516 separable assets across the six; 51k-152k
