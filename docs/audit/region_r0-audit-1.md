...
>
> Audit-1: research only. No code was changed and no finding below was fixed.
...
mechanism behind the implementer's paper cut #4.
...
## 3. Paper cut #4 — the census gate, and what I found
...
number of dirs in the tree. That is precisely the shape the paper cut names.
