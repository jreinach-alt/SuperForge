...
.include "tick_scale.asm"           ; TS_STEP: the macro the run scene's
                                    ; publisher expands. INCLUDED BEFORE THE
                                    ; SCENE, and it must be — a ca65 macro has
                                    ; to be defined before the line that
                                    ; expands it.
