; =============================================================================
; over scene — GAME OVER, and the coins the run banked
; =============================================================================
...
.scope over
.include "engine_state_over.inc"   ; GENERATED — this scene's map
