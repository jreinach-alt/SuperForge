...
.export Tad_AudioDriver_SIZE = 3250
...
Tad_DataTable := __Tad_AudioData_0 + 3366
Tad_DataTable_SIZE = 77
...
.segment "AUDIO_DATA0"
  .assert .loword(*) = $8000, lderror, "AUDIO_DATA0 does not start at the beginning of a LoRom bank ($8000)"
...
.assert .sizeof(LoadAudioData) = 51, error
  ...
  .assert .sizeof(__Tad_AudioData_0) = $6af1, error, "tad_audio_data.bin file size does not match binary size in the assembly file"
