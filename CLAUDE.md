...
- **Color-math composition** — the screen/blend vocabulary (`claims.screen` / `claims.blend`), the one-blender refusal set R1–R7, the composed `ES_SCR_*` emission, coexistence with raw claims, and the stated limits → [`docs/99`](docs/99_color_math_composition.md)
